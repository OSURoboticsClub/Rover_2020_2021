...
void ArmState::get_joint_velocities(std::vector<double> &vel_state) {
    ...
    vel_state.insert(base_current_velocity, 4);
    vel_state.insert(wrist_pitch_current_velocity, 5);
    vel_state.insert(wrist_roll_current_velocity, 6);
}
...
void ArmState::get_joint_effort(std::vector<double> &eff_state) {
    ...
    eff_state.insert(base_current_effort, 4);
    eff_state.insert(wrist_pitch_current_effort, 5);
    eff_state.insert(wrist_roll_current_effort, 6);
}